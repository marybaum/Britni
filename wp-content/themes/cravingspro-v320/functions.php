...
define( 'CRAVINGS_PRO_DIR', trailingslashit( get_stylesheet_directory() ) ); // deprecated
define( 'CRAVINGS_PRO_URI', trailingslashit( get_stylesheet_directory_uri() ) ); // deprecated
...
function cravings_pro_load_textdomain() {
	load_child_theme_textdomain( 'cravingspro', FEAST_DIR . 'languages' );
}
...
/* // removed 20181101 - bad user-experience
...
require_once FEAST_DIR . 'lib/customize/init.php';
require_once FEAST_DIR . 'lib/theme-defaults.php';
require_once FEAST_DIR . 'lib/helpers.php';
require_once FEAST_DIR . 'lib/shortcodes.php';

if ( class_exists( 'WooCommerce', false ) ) {
	require_once FEAST_DIR . 'lib/woocommerce.php';
}

if ( function_exists( 'FWP' ) ) {
	require_once FEAST_DIR . 'lib/facetwp.php';
}

if ( is_admin() ) {
	require_once FEAST_DIR . 'lib/admin/register-plugins.php';
	require_once FEAST_DIR . 'lib/admin/functions.php';
}
...
function cravings_pro_register_widgets() {
	require_once FEAST_DIR . 'lib/widgets/featured-posts/widget.php';
...
function feast_filter_genesis_seo_site_title( $title, $inside ){
	...
	if( get_header_image() == '' ) { // overwrite $child_inside to display text if no header image specified
