<?php
/**
 * CravingsPro Pro Featured Posts Widget form markup.
 *
 * @package   CravingsPro\Views\Widgets
...
?>
<p>
	<label for="<?php $this->field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'cravingspro' ); ?></label>
...
<p>
	<label for="<?php $this->field_id( 'facet' ) ?>"><?php esc_html_e( 'Show facet:', 'cravingspro' ) ?></label>

	<select class="widefat" name="<?php $this->field_name( 'facet' ) ?>">
		<option value=""><?php esc_html_e( 'Choose facet', 'cravingspro' ) ?></option>
...
<p>
	<label for="<?php $this->field_id( 'reset' ) ?>"><?php esc_html_e( 'Show reset button:', 'cravingspro' ) ?></label>
	<input id="<?php $this->field_id( 'reset' ); ?>" type="checkbox" name="<?php $this->field_name( 'reset' ); ?>"<?php checked( $data['reset'] ) ?>>
</p>

<p>
	<label for="<?php $this->field_id( 'reset_text' ); ?>"><?php esc_html_e( 'Reset button text:', 'cravingspro' ); ?></label>
