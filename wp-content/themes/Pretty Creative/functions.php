...
add_action( 'wp_enqueue_scripts', 'nn_google_fonts' );
function nn_google_fonts() {
	wp_enqueue_style( 'dashicons' );
	wp_enqueue_style( 'nn1_google-fonts', '//fonts.googleapis.com/css?family=Open+Sans:300,400,400i,600,700,800"', array(), CHILD_THEME_VERSION );
	wp_enqueue_style( 'nn2_google-fonts', '//fonts.googleapis.com/css?family=Montserrat', array(), CHILD_THEME_VERSION );
	...
	wp_register_style('nn_scripts' , get_stylesheet_directory_uri() . '/fonts/scripts.css');
	wp_enqueue_style('nn_scripts');
...
function excerpt_read_more_link($output) {
	global $post;
	return $output . '<a href="'. get_permalink($post->ID) . '"> <div class="readmorelink"><div class="rmtext"> More. </div></div></a>';
}
...
//* Subscribe Widget
add_action( 'genesis_entry_footer', 'custom_subscribe_widget' );
